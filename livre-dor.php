...
<head>
	...
	<title>Espace Beauté | Saint-Loubès | Livre d'or</title>
	<?php include('inc/header.php'); ?>
	
</head>
<body class="livre-dor">
		...
		<div class="contenu">
			...
			<div class="row inscription">
				<form id="formulaire" method="post" action="livre-dor.php">
					...
					<div class="large-6 medium-6 small-12 columns">
						<textarea id="message" name="message" placeholder="Votre témoignage ici"></textarea>
					</div>
					<div class="large-12 columns">
	...
	<script>
		...
		$(document).ready(function(){
			...
			$('nav a:nth-child(6), footer a:nth-of-type(6)').addClass('active');
