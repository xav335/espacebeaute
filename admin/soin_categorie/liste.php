			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">Indiquez le titre et sous-titre de la catégorie</h3>
						</div>
						<div class="panel-body">
							<form name="formulaire" class="form-horizontal" method="POST" action="/admin/soin_categorie/traitement.php" >
								...
								<div class="row">
									...
									<div class="row">
										<label class="col-md-3">&nbsp;Sous-titre :</label>
					      				<input type="text" class="col-md-5" name="sous_titre" id="sous_titre" value="<?=$sous_titre?>">
					      			</div>
								</div>	
				...
				if ( !empty( $liste_categorie ) ) {
					...
					<table class="table table-hover table-bordered table-condensed table-striped" >
						<thead>
							<tr>
								<th class="col-md-5">Liste des catégories</th>
								<th class="col-md-6">Sous-titre</th>
						...
						foreach ( $liste_categorie as $_categorie ) {
							echo "<tr>\n";
							echo "	<td>\n";
							echo "		<a href='/admin/soin_categorie/liste.php?id=" . $_categorie[ "id" ] . "'>" . $_categorie[ "titre" ] . "</a>\n";
							echo "	</td>\n";
							echo "	<td>" . $_categorie[ "sous_titre" ] . "</td>\n";
							echo "	<td><a href='/admin/soin_categorie/liste.php?id=" . $_categorie[ "id" ] . "'><img src='/admin/img/modif.png' width='30' alt='Modifier' ></a></td>\n";
							...
							echo "			<button type='button' class='btn btn-danger' onclick=\"location.href='/admin/soin_categorie/traitement.php?action=delete&id=" . $_categorie[ "id" ] . "'\">Oui !</button>\n";
							echo "	 	</div>\n";
